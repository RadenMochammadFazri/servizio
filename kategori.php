  ...
  <nav class="w-full fixed left-0 top-0 z-50 nav">
    ...
    <div class="container lg:grid grid-cols-12 items-start gap-6 pt-16 top-32 relative">
      ...
      <div class="col-span-3">
        <!-- profile links -->
        <div class="bg-dark shadow rounded p-4 divide-y divide-gray-200 space-y-4 text-gray-600">
          <!-- single link -->
          <div class="space-y-1">
          ...
          <!-- single link -->
          <?php
         $select = "SELECT id_kategori,kategori FROM kategori  WHERE id_kategori=1 ";
         ...
         while ($baris=$hasil->fetch_assoc()) {
          ...
          <div class='space-y-1 pt-4'>
            <a href='kategori.php?id=$id_kategori' class='relative medium capitalize text-white font-medium hover:text-primary transition block'> Programming </a>
          </div>";
        }}
        ?>
          <!-- single link end -->
          <!-- single link -->
          <?php
         $select = "SELECT id_kategori,kategori FROM kategori  WHERE id_kategori=2 ";
         $hasil = mysqli_query($conn,$select);
         if($hasil->num_rows > 0){
         while ($baris=$hasil->fetch_assoc()) {
             $id_kategori=$baris['id_kategori'];
             ...
             echo"       
          <div class='pt-4'>
            <a href='kategori.php?id=$id_kategori' class='relative medium capitalize text-white font-medium hover:text-primary transition block'> Video Editing </a>
          </div>";
        }}
        ?>
          <!-- single link end -->
          <!-- single link -->
          <?php
         $select = "SELECT id_kategori,kategori FROM kategori  WHERE id_kategori=3 ";
         $hasil = mysqli_query($conn,$select);
         if($hasil->num_rows > 0){
         while ($baris=$hasil->fetch_assoc()) {
             $id_kategori=$baris['id_kategori'];
             ...
             echo"       
          <div class='pt-4'>
            <a href='kategori.php?id=$id_kategori' class='relative medium capitalize text-white font-medium hover:text-primary transition block'> Design Graphic </a>
          </div>";
        }}
        ?>
          <!-- single link  -->
          <?php
         $select = "SELECT id_kategori,kategori FROM kategori  WHERE id_kategori=4 ";
         $hasil = mysqli_query($conn,$select);
         if($hasil->num_rows > 0){
         while ($baris=$hasil->fetch_assoc()) {
             $id_kategori=$baris['id_kategori'];
             ...
             echo"       
          <div class='space-y-1 pt-4'>
            <a href='kategori.php?id=$id_kategori' class='relative medium capitalize text-white font-medium hover:text-primary transition block'> Digital Marketing </a>
          </div>";
        }}
        ?>
          <!-- single link end  -->
          <!-- single link  -->
          <?php
         $select = "SELECT id_kategori,kategori FROM kategori  WHERE id_kategori=5 ";
         $hasil = mysqli_query($conn,$select);
         if($hasil->num_rows > 0){
         while ($baris=$hasil->fetch_assoc()) {
             $id_kategori=$baris['id_kategori'];
             ...
             echo"       
          <div class='space-y-1 pt-4'>
            <a href='kategori.php?id=$id_kategori' class='relative medium capitalize text-white font-medium hover:text-primary transition block'> Music & Audio </a>
          </div>";
        }}
        ?>
          <!-- single link end  -->
          <!-- single link  -->
          <?php
         $select = "SELECT id_kategori,kategori FROM kategori  WHERE id_kategori=6 ";
         $hasil = mysqli_query($conn,$select);
         if($hasil->num_rows > 0){
         while ($baris=$hasil->fetch_assoc()) {
             $id_kategori=$baris['id_kategori'];
             ...
             echo"       
          <div class='space-y-1 pt-4'>
            <a href='kategori.php?id=$id_kategori' class='relative medium capitalize text-white font-medium hover:text-primary transition block'> Writing </a>
          </div>";
        }}
        ?>
          <!-- single link end  -->
    ...
    <!-- footer start -->
    <footer class="bg-darkest pt-16 pb-12 mt-48 relative border-t border-gray-500">
      <div class="container">
