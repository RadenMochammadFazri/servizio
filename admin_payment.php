    ...
    <div class="lg:grid grid-cols-12 items-start gap-6">
      ...
      <div class="col-span-3">
        <div class="bg-dark shadow lg:h-screen p-4 divide-y divide-gray-200 space-y-4 text-gray-600">
          ...
          <!-- single link -->
          <div class="pl-8 pt-4">
            <a href="admin_payment.php" class="relative medium capitalize text-primary font-medium hover:text-primary transition block">
              All Payments
              <span class="absolute -left-8 top-0 text-base text-white">
      ...
      <div class="col-span-9 shadow rounded px-6 pt-5 pb-7 mt-6 lg:mt-0 p-5 h-screen bg-dark">
        <h3 class="font-medium capitalize mb-4 text-white text-center text-2xl">All Payments</h3>
          ...
          <table class="w-full">
            ...
            <thead class="bg-gray-700 border-b-2 border-white">
              <tr>
                ...
                <th class="p-3 text-sm font-semibold tracking-wide text-white text-center">Payment <br />Method</th>
            ...
            <tbody class="divide-y divide-gray-500">
              <!-- row 1 start  -->
              <?php
              $select = "SELECT DISTINCT cart.id_produk,cart.harga_produk ,proses.id_servis, proses.id_produk,proses.invoice,proses.metode, proses.tanggal 
